...
$url = 'http://agenda.uai.cl/clasesRotativa.aspx?codUbicacion=133&bannerWidth=0&tamanoLetra=24px&numFilas=600&frecuenciaSegundosHorarios=10&diasAdelanto=0&mostrarFinalizados=false&codUso=53o55o57o60o61o63o66o67o69o70';
$ch = curl_init();
...
$fp = fopen("horario_temp_post.html", "w");
...
$modulonorep=array_unique($modulo);
		while($j<count($modulo)) {
		 ...
		 else {     fwrite($fp,$modulonorep[$k].$ramo[$j].$sala[$j]);
		 }
		 		 $j++;
		}
		fclose($fp);
